...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(508, 413)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(10, 10, 481, 361))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "script 18. String Finder"))
        self.menu.setTitle(_translate("MainWindow", "File"))
        self.menu_2.setTitle(_translate("MainWindow", "Log"))
        self.file_open_action.setText(_translate("MainWindow", "Open..."))
        self.log_export_action.setText(_translate("MainWindow", "Export..."))
        self.log_add_action.setText(_translate("MainWindow", "Add to log "))
        self.log_check_action.setText(_translate("MainWindow", "Checkout logs"))
