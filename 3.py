...
pattern = re.compile("[8]{1}[3]{1}\d{3}[,]{1}\s\w*")
cnt = 0
...
class MyWin(QtWidgets.QMainWindow):
    ...
    def log_check(self):
        ...
        pattern_for_coincidences = re.compile("Строка #\d+, позиция #\d+: найдено <[8]{1}[3]{1}\d{3}[,]{1}\s\w+>")
    ...
    # Если файла script18.log нет - создаём его
